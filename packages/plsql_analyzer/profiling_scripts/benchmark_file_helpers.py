...
def benchmark():
    ...
    # 2. Benchmark derive_package_name_from_path
    ...
    print(f"derive_package_name_from_path: Total time for {iterations} iterations: {time_derive:.4f} seconds")
    print(f"derive_package_name_from_path: Average time per call: {time_derive/iterations:.6f} seconds")
